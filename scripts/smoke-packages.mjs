...
const PKGS = ["sdk", "cli", "mcp", "advisor-sdk", "advisor-mcp", "advisor-cli"];
// packages/<grupo>/<pacote>: os clientes do contrato core moram em core/, os do Advisor em advisor/.
const dirDe = (p) => join(REPO, "packages", p.startsWith("advisor-") ? "advisor" : "core", p);
