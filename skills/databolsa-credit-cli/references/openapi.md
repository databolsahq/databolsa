...
Prefer `@databolsa/credit-cli --list` for discovery and
`@databolsa/credit-cli <operation> --help` for shell syntax. Query the contract
...
```bash
npx --yes @databolsa/credit-cli deskListWatchlists --help
```
