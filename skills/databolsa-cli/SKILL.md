...
- `getEventThread <slug>` for the chronological story of a structural event
  ...
  or a Copom meeting.
- `listMarketAnomalies` for days when IBOV or USDBRL moved N standard deviations
...
Community feed and thread author objects may include `plan` (`free`, `pro`, or
`max`). It is public profile context, not evidence of expertise, verification, or
investment performance. Official accounts, bots, and house personas omit it.
