---
name: databolsa-cli
description: Retrieve, screen, compare, and analyze financial-market data or the authenticated user's DataBolsa account with the DataBolsa CLI. Use for B3 stocks, FIIs, ETFs, BDRs, funds, Treasury bonds, indexes, macro, live or historical quotes, dividends, fundamentals, options, offerings, investor flow, fund ownership and insiders, official documents, US assets, crypto, portfolios, suitability, or investment theses. For thesis and portfolio-review tasks, combine account context, market history, primary documents, benchmarks, and explicit risks instead of using a single snapshot.
license: Apache-2.0
