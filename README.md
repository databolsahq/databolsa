...
| Pacote | O que é |
| --- | --- |
| `packages/advisor-sdk` | Cliente TypeScript tipado do contrato do Advisor. |
| `packages/advisor-cli` | CLI do Advisor — um comando por operação (`databolsa-advisor`). |
| `packages/advisor-mcp` | Servidor MCP com as tools `advisor*` do escritório. |
