...
renderiza a resposta. Lógica financeira, unidades, linhagem e cache vivem na API
e no warehouse.
...
| `DATABOLSA_API_KEY` | vazio | Token Bearer. **Obrigatório na API hospedada** (`api.databolsa.com`); opcional num core self-hosted aberto. Crie a sua em [databolsa.com/conta](https://databolsa.com/conta). |
