 ...
 * BUG-0064) — mesmo footgun do optionalFiniteNumber em
 * packages/api/src/lib/validators.ts, espelhado aqui pq o client roda fora do
 * processo da API. String vazia/branca → AUSENTE; .finite() rejeita Infinity/NaN.
 */
