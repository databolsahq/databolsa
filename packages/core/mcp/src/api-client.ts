...
export class ApiClient {
  ...
  /** Path do spec vivo servido na origem. */
  ...
  /** A credencial da sessão — para tools que chamam a API por OUTRO cliente (o SDK). */
  ...
  async fetchOpenApi(): Promise<unknown> {
    const res = await fetch(`${this.origin}${this.specPath}`, {
