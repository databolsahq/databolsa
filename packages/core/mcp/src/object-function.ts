...
export function inputsDoContrato(operations: readonly Operation[]): InputsPorFuncao {
  ...
  // O sujeito de CADA tipo sai da lista: uma mesma função pode se instanciar por chaves
  // diferentes conforme o tipo, e deixar uma delas entrar como input trocaria o objeto por
