...
describe("superfície do SDK × contrato público", () => {
  it("o contrato tem operationIds para conferir", () => {
    expect(operationIds.length).toBeGreaterThan(80);
...
// que estiver declarado nela. As duas superfícies driftaram em silêncio: a classe tinha todos
// os métodos e a interface estava sem três. Método ausente numa interface não é erro de
// compilação, é omissão.
//
