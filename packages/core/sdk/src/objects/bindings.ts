 ...
 * dizia era qual chave de `defaults` vai no CAMINHO da rota e qual vai na query — `listQuotes`
 * recebe `ticker` posicional, `listCreditRatings` recebe `assetCode` como filtro. Desde 28/08/2026
