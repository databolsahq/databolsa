...
await runCli({
  ...
  modules: {
    ...
    wallet: {
      ...
      blurb: "Wallet; acesso depende da instalação no workspace da sua chave",
    },
  },
  branding: {
    bin: "databolsa",
    ...
    examples: [
      ...
      "databolsa rankObjects --kind equity_security --fact pl --where 'pl<10,issued:in.roe>0.15' --order asc --limit 20",
