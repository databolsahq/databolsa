...
export interface paths {
    ...
    "/v1/events/anomalies": {
         ...
         * @description Dias em que uma série acompanhada (IBOV, IFIX, dólar, brent, VIX, S&P 500) se moveu N desvios-padrão além do regime dos 252 pregões anteriores (histórico desde 1968), com o evento explicador quando casado. Um dia anômalo sem explicação é lacuna de cobertura do ledger, não ausência de causa.
         */
...
export interface components {
    schemas: {
        ...
        PublicMarketAnomaly: {
            ...
            return_pct: number;
            /** @description Desvios-padrão vs σ rolling de 252 pregões. */
            zscore: number;
        ...
        CommunityItem: {
            ...
            author?: {
                ...
                kind?: string;
                /**
                 * @description Plano público da conta autora. Ausente para conta oficial, bots e personas.
                 * @enum {string}
                 */
                plan?: "free" | "pro" | "max";
            };
