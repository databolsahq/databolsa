...
export class HttpClient implements DataBolsaClient {
  ...
  getObjectProperties(id: string, params?: { resolve?: "auto" | "exact" }) {
    return this.request<ObjectPropertiesResponse>(`/objects/${enc(id)}/properties`, {
      resolve: params?.resolve,
    });
  }
  ...
  listFundManagers(params?: {
    cursor?: string;
    limit?: number;
    q?: string;
  }): Promise<FundManagersResponse> {
    return this.request<FundManagersResponse>("/funds/managers", {
      cursor: params?.cursor,
      limit: params?.limit,
      q: params?.q,
    });
  ...
  listFundCreditHoldings(
    ...
    return this.request<FundCreditHoldingsResponse>(`/funds/${enc(cnpj)}/credit-holdings`, {
      cursor: params?.cursor,
      limit: params?.limit,
      date: params?.date,
  ...
  listCreditFundHolders(
    ...
    return this.request<CreditFundHoldersResponse>(`/credit/securities/${enc(isin)}/fund-holders`, {
      cursor: params?.cursor,
      limit: params?.limit,
      date: params?.date,
    });
  ...
  listFidcOriginators(cnpj: string, params?: { date?: string }): Promise<FidcOriginatorResponse> {
    return this.request<FidcOriginatorResponse>(
      `/credit/fidc/${encodeURIComponent(cnpj)}/originators`,
      { date: params?.date },
    );
  }
  ...
  listFidcFlows(
    ...
    return this.request<FidcFlowResponse>(`/credit/fidc/${encodeURIComponent(cnpj)}/flows`, {
      from: params?.from,
      to: params?.to,
      cursor: params?.cursor,
      limit: params?.limit,
  ...
  listFidcPerformance(
    cnpj: string,
    params?: { date?: string },
  ): Promise<FidcPerformanceResponse> {
    return this.request<FidcPerformanceResponse>(
      `/credit/fidc/${encodeURIComponent(cnpj)}/performance`,
      { date: params?.date },
    );
  }
  ...
  listFidcReturns(
    ...
    return this.request<FidcReturnResponse>(`/credit/fidc/${encodeURIComponent(cnpj)}/returns`, {
      from: params?.from,
      to: params?.to,
      limit: params?.limit,
    });
  ...
  getOriginatorProfile(cnpj: string): Promise<OriginatorProfile> {
    return this.request<OriginatorProfile>(
      `/credit/originators/${encodeURIComponent(cnpj)}/profile`,
    );
  }
  ...
  listFidcPortfolioOps(
    ...
    return this.request<FidcPortfolioOpsResponse>(
      `/credit/fidc/${encodeURIComponent(cnpj)}/portfolio-ops`,
      { from: params?.from, to: params?.to, cursor: params?.cursor, limit: params?.limit },
    );
  }
