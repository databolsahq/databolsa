 ...
 *
 * A carteira pertence a um WORKSPACE: por default o pessoal do dono da chave. `workspace`
 * (id da organização) opera as carteiras de uma organização de que a pessoa é membro —
 * viaja no header `x-databolsa-workspace`.
 */
...
export interface WalletClientOptions {
  ...
  apiKey?: string;
  /** Id da organização em que agir (header `x-databolsa-workspace`); `personal` força o pessoal. */
  workspace?: string;
