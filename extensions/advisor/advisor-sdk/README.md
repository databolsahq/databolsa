...
A chave é pessoal e deve permanecer no servidor. A organização vem da própria chave, fixada
quando ela foi criada — crie-a dentro do escritório em que quer agir. `getMe()` mostra as
...
Documentação: [docs.databolsa.com/extensoes/advisor](https://docs.databolsa.com/extensoes/advisor).
